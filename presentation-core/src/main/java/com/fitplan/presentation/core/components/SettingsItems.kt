...
import com.fitplan.core.common.preference.toggle
import com.fitplan.presentation.core.components.material.DISABLED_ALPHA
import com.fitplan.presentation.core.components.material.Slider
import com.fitplan.presentation.core.components.material.padding
import com.fitplan.presentation.core.theme.header
...
fun SortItem(label: String, sortDescending: Boolean?, onClick: () -> Unit) {
    val arrowIcon = when (sortDescending) {
        true -> Icons.Filled.ArrowDownward
        false -> Icons.Filled.ArrowUpward
        null -> null
    }
    ...
    Row(
        ...
        Icon(
            imageVector = when (state) {
                TriState.DISABLED -> Icons.Filled.CheckBoxOutlineBlank
                TriState.ENABLED_IS -> Icons.Filled.CheckBox
                TriState.ENABLED_NOT -> Icons.Filled.DisabledByDefault
            },
            contentDescription = null,
